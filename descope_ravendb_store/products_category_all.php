...
$pageid = strip_tags($_GET['products_id']);


if(preg_match('/[^a-z_\-0-9]/i', $pageid))
{
  echo "<div style='color:white;background:red;padding:8px;border:none;'>Ilegal or invalid Characters on Products page not allowed...</div>";
exit();
}
...
<h3><center > <b style='color:#800000'>Products Category: <?php echo $pageid; ?></b></center></h3>
...
if($TotalResults == 0){
echo "<div class='alerts_fades' style='background:red;color:white;padding:10px;border:none;'>No Products Publish Yet for <b>($pageid)</b> CarLending Category </div>";
...
<b>Lending Price:</b> <span class='time_css2'><?php echo $price; ?> (USD)</span><br>
